...
{ 
	public static void geraPdf(String jrxml, BigDecimal pNunota) 
	{
		try 
		{
			...
			//OutputStream saida = new FileOutputStream("\\"+"\\192.168.0.10\\srv-arq\\PUBLICA"+"\\STI"+"\\Adriano"+"\\propvenda.pdf");
			OutputStream saida = new FileOutputStream("C:\\AtualizadoresSankhyaDevExterno\\propostadevenda\\Proposta de venda.pdf");
